...
class amax_applybp {
   ...
   public: 
      [[eosio::action]] void applybp( const name& owner,
      ...
      [[eosio::action]]  void updatebp(const name& owner,
                  const string& logo_uri,
                  const string& org_name,
                  const string& org_info,
                  const name& dao_code,
      ...
      [[eosio::action]]  void addproducer(const name& submiter,
                  const name& owner,
                  const string& logo_uri,
                  const string& org_name,
                  const string& org_info,
      ...
      using applybp_action = eosio::action_wrapper<"applybp"_n, &amax_applybp::applybp>;
      using updatebp_action = eosio::action_wrapper<"updatebp"_n, &amax_applybp::updatebp>;
      using addproducer_action = eosio::action_wrapper<"addproducer"_n, &amax_applybp::addproducer>;
};
